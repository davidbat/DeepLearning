...
def main():
	...
	train_labels = dec_labels_by_one(map(lambda i: mat['gnd'][i-1][0], train_idx))
	valid_labels = dec_labels_by_one(map(lambda i: mat['gnd'][i-1][0], valid_idx))
	test_labels = dec_labels_by_one(map(lambda i: mat['gnd'][i-1][0], test_idx))
